...
public class OrderServiceImpl implements OrderService{
	...
	public Order getOrder(Integer id) {
		...
		System.err.println("form order: sutdent==="+student.getID()+","+student.getName());
	...
	public List<Order> getOrders(Integer id) {
		...
		System.err.println("from orders>>>>>>sutdent==="+student.getID()+","+student.getName());
		Order order = new Order();
		order.setID(110L);
		order.setOrderId("12457896321478");
	...
	public Order updateOrder(Order order) {
		...
		System.err.println("====New Stu===="+ stu.toString());
		return null;
	}
}
